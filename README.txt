...
2. Не забываем фризить зависимости командой python -m pip freeze > requirements.txt и ставить их себе в venv при продолжении работы над проектом с помощью pip install -r requirements.txt
